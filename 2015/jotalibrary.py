...
class bcolors:
    """Global constants for colours when writing to the terminal"""
    HEADER = '\033[95m'
    OKBLUE = '\033[94m'
    OKCYAN = '\033[96m'
    OKGREEN = '\033[92m'
...
###### Already used this Graph code in 2022-2024
...
class Graph(object):
    ...
    def print_result(self, previous_nodes, shortest_path, start_node, target_node):
        ...
        print("We found the following best path with a value/cost of {}.".format(shortest_path[target_node]))
